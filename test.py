...
gazedata_filename = "gaze_data_test.csv"
...
# PYTHON 2.x
with open(gazedata_filename, mode='wb') as gaze_data_file:
    
    fieldnames = [data for data in gaze_stuff]
    gaze_data_writer = csv.DictWriter(gaze_data_file, fieldnames=fieldnames, delimiter=";")

    gaze_data_writer.writeheader()
    for gaze_data in global_gaze_data:
