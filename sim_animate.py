...
# Session to run
#session_folder = "infant3_25d_marley_7m"
session_folder = "ctrl_group_marie"
...
controller.animate_test(gaze_data_left, gaze_data_right, gaze_data_left_corrected, gaze_data_right_corrected, target_points, frame_delay = 0.000)