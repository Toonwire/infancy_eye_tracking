...
class DataCorrection:
    ...
    transformation_matrix_left_eye = None
    transformation_matrix_right_eye = None
    ...
    def adjust_left_eye(self, fixations):
        if self.transformation_matrix_left_eye == None:
    ...
    def adjust_right_eye(self, fixations):
        if self.transformation_matrix_right_eye == None:
